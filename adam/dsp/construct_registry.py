...
def build_construct_registry() -> Dict[str, Dict[str, Any]]:
    ...
    for cog_id, name, desc, ad_rel, citations in [
        ...
        ("construal_level_state", "Construal Level State", "Abstract (why, values) vs concrete (how, features) mental representation", "High construal: benefits, percent-off. Low construal: features, dollar-off. Match yields d=0.276 (pre-registered; publication-bias-corrected from published g=0.475). See effect_size_correction.CLT_MATCHING_EFFECT.", ["Trope & Liberman (2010)"]),
